...
public class Server {
	...
	public void serverStart(String serverhost) {
		...
		try {
			...
			// bei Test im Netzwerk über zwei Rechner, könnte das binden nach der Objekterzeugung Probleme machen
			...
			while (true) {
				...
				/*
				 * beim zweiten senden einer Message-> out of ApplicationThread
